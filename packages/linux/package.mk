...
case "$LINUX" in
  amlogic-3.10)
    ...
    ;;
  amlogic-3.14)
    PKG_VERSION="98b18c05a5c1c878bd01ecbc6c9d1b33dde622bb"
    PKG_SHA256="3badd5fff943fa66e86c75cb7709dfe2dc609f73d7d08a92c0f634eb9696878d"
    ...
    ;;
  amlogic-4.9)
    PKG_VERSION="ae248714d0e7f4f67452272c5cf3003e328b2926"
    PKG_SHA256="8526992d31b75f6d811f06e6ac39f59da6bd705c2e99a551e077ae901dc9aec7"
    PKG_URL="https://github.com/CoreELEC/linux-amlogic/archive/$PKG_VERSION.tar.gz"
    PKG_SOURCE_NAME="linux-$LINUX-$PKG_VERSION.tar.gz"
    PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET aml-dtbtools:host"
    PKG_BUILD_PERF="no"
